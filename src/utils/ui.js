...
import winsound from '../Sounds/player_won.wav';
import losssound from '../Sounds/loss.mp3';
...
const renderShowdownMessages = (showDownMessages) => {
  return showDownMessages.map((message, index) => {
    ...
    console.log('HELOOOOOOOOOOOOOOOOOO USERRRRRRRRRRRRR', users[0]);
    if (users === 'GUEST 1' || users[0] === 'GUEST 1') {
